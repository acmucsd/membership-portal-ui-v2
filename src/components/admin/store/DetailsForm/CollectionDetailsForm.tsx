...
const CollectionDetailsForm = ({ mode, defaultData, token }: IProps) => {
  ...
  const confirmDelete = useConfirm({
    ...
    question:
      'Are you sure you want to delete this collection? All items in the collection will be lost forever. This cannot be undone.',
    action: 'Delete',
  });
        ...
        <div className={style.submitButtons}>
          {mode === 'edit' ? (
            <>
              ...
              <Button
                onClick={() => confirmDelete.confirm(deleteCollection)}
                disabled={loading}
                destructive
              >
                Delete collection
